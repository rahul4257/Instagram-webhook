...
const REMINDER_TEXTS = {
  ...
  PACKAGES_SHOWN:
    "Package selection is open ❤️ Send the package number or package name and we will continue.",
...
async function processReminder(
  ...
  try {
    ...
    /*
       IMPORTANT LOCKED-FLOW STATE FIX.

       When the reminder sends Message 1, only Message 1 is marked sent.
       When it sends Message 2, only Message 1 + Message 2 are marked sent.
       The package list is marked sent only when the package list itself
       is actually sent.

       Never mark the NEXT message as already sent.
    */
