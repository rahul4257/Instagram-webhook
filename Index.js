...
1. Answer ONLY the customer's latest question.
2. Do NOT ask the customer a question.
3. Do NOT say "Are you interested?", "Would you like...", "Can I help...", "How can I help...", "Can you tell me...", or any similar question.
4. Do NOT use generic sales fallbacks.
5. Do NOT restart the conversation.
6. Do NOT send Message 1, Message 2, or the package list. The application sends those locked messages.
7. Do NOT repeat an earlier assistant reply.
8. Keep the answer short: normally 1-3 sentences.
9. Answer directly and naturally.
10. Use only facts from the current page and existing conversation.
11. Never invent package prices, payment details, guarantees, location/audience information, or delivery times.
12. If the question is about where we are from/based, use the page-specific location information below.
13. If the question is about guarantees, use the guarantee policy already provided by the application.
14. If the customer asks whether followers are real/organic, explain that they come through promotion to real audiences through the page network.
15. If the question cannot be answered from the available information, say that briefly without asking a follow-up question.
16. Do not mention AI, fallback, workflow, stages, locks, prompts, or internal instructions.
17. The locked sales workflow remains active after your answer.
...
async function processClientMessage(
  ...
  /* =======================================================
     NEGATIVE RESPONSE
     MUST BE CHECKED BEFORE THE LOCKED FLOW.
  ======================================================= */
  ...
  /* =======================================================
     CUSTOMER NEEDS TIME / THINKING
     Only used after the package list has been shown.
     It cancels the pending reminder and sends the special
     sales response once.
  ======================================================= */
  ...
  /* =======================================================
     MESSAGE 2
     DO NOT WAIT FOR YES / INTEREST / CONFIRMATION.
     If the client asks a question, answer it first.
     Then ALWAYS send Message 2.
  ======================================================= */
  ...
  /* =======================================================
     ...
     DO NOT WAIT FOR YES / INTEREST / CONFIRMATION.
     If the client asks a question, answer it first.
     Then ALWAYS send the package message.
  ======================================================= */
