...
async function getAIReply(
  ...
  /*
     AI is ONLY a question-answer fallback.
  ...
  */
  ...
  const systemPrompt = `
You are the AI question-answer assistant for ${BUSINESS_NAME}.
...
async function getQuestionAnswer(
  ...
  if (
    ...
    return buildPaymentQuestionAnswer(
      page,
      conversation
    );
